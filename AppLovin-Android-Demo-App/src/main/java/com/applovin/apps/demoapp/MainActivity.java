...
import com.applovin.apps.demoapp.mrecs.MRecProgrammaticActivity;
        ...
        extends DemoMenuActivity
{
    ...
    protected DemoMenuItem[] getListViewContents()
    {
        DemoMenuItem[] result = {
                ...
                new DemoMenuItem( "MRecs", "300x250 Rectangular ads typically used in-content", new Intent( this, MRecProgrammaticActivity.class ) ),
